...
import framework.global.Configuration;
/**
 * This class override some methods of HTMLLayout to redesign the output log format.
 * The new log includes a header 
 * Date : 2017-04-27
 * Owner : yuhong.ma
 * @author yuhong.ma
*/
public class FormatHTMLLayout extends HTMLLayout {   
    ...
    String title = ScenarioRunning.runningScenario;   
    ...
    public String format(LoggingEvent event) { 
        ...
        if (event.getLevel().equals(Level.FATAL)) { 
            ...
            sbuf.append("<td>");
            sbuf.append("<a href=\""+Configuration.pro.getReportLinkPrefix()+ link + "\">");  
        ...
        if (s != null) {   
            ...
            sbuf.append("<tr><td bgcolor=\"#993300\" style=\"color:White; font-size : x-small;\" colspan=\"4\">");   
 ...
 //       sbuf.append("<title>" + title + "</title>" + Layout.LINE_SEP);   
        ...
        sbuf.append("<tr>" + Layout.LINE_SEP);
        sbuf.append("<th colspan=\"4\">Browser: " + "Firefox" + "</th>" + Layout.LINE_SEP);
        sbuf.append("</tr>" + Layout.LINE_SEP);
 ...
 //     sbuf.append("</tr>" + Layout.LINE_SEP);
        ...
        sbuf.append("<tr>" + Layout.LINE_SEP);
        sbuf.append("<th colspan=\"4\">Scenario: " + title + "</th>" + Layout.LINE_SEP);
        sbuf.append("</tr>" + Layout.LINE_SEP); 
   ...
   // String title = ScenarioRunning.scenarioRunning;   
    ...
    public String format(LoggingEvent event) { 
        ...
        if (event.getLevel().equals(Level.FATAL)) { 
            ...
            //mary, I will add screen snapshot later here
            sbuf.append(Transform.escapeTags(link));    
            sbuf.append("</a>" + Layout.LINE_SEP);  
            sbuf.append("</td>" + Layout.LINE_SEP); 
